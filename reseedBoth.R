...
max(as.numeric(rownames(combined.ones)))
max(as.numeric(rownames(combined.zeros)))
max(as.numeric(rownames(combined)))
length(as.numeric(rownames(combined)))
length(as.numeric(rownames(combined.ones)))
length(as.numeric(rownames(combined.zeros)))
